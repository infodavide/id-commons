...
public final class Constants {
    ...
    public static final String CREATION_DATE_COLUMN = "cdate";
    ...
    public static final String MODIFICATION_DATE_COLUMN = "mdate";

    /** The Constant NAME_COLUMN. */
    public static final String NAME_COLUMN = "name";

    /** The PASSWORD_COLUMN. */
    public static final String PASSWORD_COLUMN = "passwd"; // NOSONAR Database column
