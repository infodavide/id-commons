    ...
    public DatabaseConnectorRegistry() {
        ...
        while (ite.hasNext()) {
            ...
            try {
                ...
                LOGGER.info("DatabaseConnectionDescriptor connector for driver {} installed", connector.getSupportedDriver());
            } catch (@SuppressWarnings("unused") final ClassNotFoundException e) {
                LOGGER.warn("DatabaseConnectionDescriptor connector for driver {} cannot be installed, driver was not found", connector.getSupportedDriver());
            }
        }
